...
class PPOAgent:
    ...
    def __init__(self, state_shape, num_actions, buffer_size, num_envs, gamma, gae_lambda, epsilon, epochs, 
        ...
        self.epochs = epochs
        self.buffer = PPOBuffer(buffer_size, num_envs, state_shape, gamma, gae_lambda)
        self.model = PPOModel(learning_rate, gradient_clipping, state_shape, num_actions, epsilon, max_kl_diverg)
